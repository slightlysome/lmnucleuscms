...
*/
	 ...
	 * @todo document this
	 */
	public function action_editmembersettings($memberid = '') {
		global $member, $manager, $CONF;
	 ...
	 * @todo document this
	 */
	private function _showActivationPage($key, $message = '')
	{
		global $manager;
...
?>
	 ...
	 * @todo document this
	 */
	private function _templateEditRow(&$template, $description, $name, $help = '', $tabindex = 0, $big = 0) {
		static $count = 1;
	 ...
	 * @todo document this
	 */
	public function action_settingsedit() {
...
*/
	 ...
	 * @todo document this
	 */
	public function updateConfig($name, $val) {
		$name = sql_real_escape_string($name);
