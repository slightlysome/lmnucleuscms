...
define('_SKINFILES_ERR_COULD_NOT_RENAME_DIR3',	'エラー: 設定した名前に１つ以上の無効な文字が含まれていましたので ');
...
define('_SKINFILES_ERR_COULD_NOT_CREATE_DIR2',	'エラー: 設定した名前に１つ以上の無効な文字が含まれていましたので ');
...
define('_SKINFILES_ERR_RENAME_FILE6',			'エラー: 設定した名前に１つ以上の無効な文字が含まれていましたので ');
...
define('_SKINFILES_ERR_CREATE_FILE2',			'エラー: 設定した名前に１つ以上の無効な文字が含まれていましたので、');
...
define('_SKINFILES_ERR_UPLOAD_FILE5',			'エラー: 設定した名前に１つ以上の無効な文字が含まれていましたので、ファイル ');
