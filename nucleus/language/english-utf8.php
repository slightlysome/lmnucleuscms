<?php
// English LMNucleus Language File
//
...
// delete member
define('_WARNINGTXT_NOTDELMEDIAFILES',				'Please note that media files will <b>NOT</b> be deleted. (At least not in this LMNucleus version)');	// <add by shizuki />
...
define('_BOOKMARKLET_DESC3',						'and a LMNucleus add-item window will popup, ');
...
define('_ERRORS_STARTUPERROR1',						'<p>One or more of the LMNucleus installation files are still present on the webserver, or are writable.</p><p>You should remove these files or change their permissions to ensure security. Here are the files that were found by LMNucleus</p> <ul><li>');
...
define('_BACKUP_BACKUPFILE_TITLE',					'This is a backup file generated by LMNucleus');
define('_BACKUP_BACKUPFILE_BACKUPDATE',				'backup-date:');
define('_BACKUP_BACKUPFILE_NUCLEUSVERSION',			'LMNucleus CMS version:');
define('_BACKUP_BACKUPFILE_DATABASE_NAME',			'LMNucleus CMS Database name:');
define('_BACKUP_BACKUPFILE_TABLE_NAME',				'TABLE:');
define('_BACKUP_BACKUPFILE_TABLEDATAFOR',			'Table Data for %s');
define('_BACKUP_WARNING_NUCLEUSVERSION',			'WARNING: Only try to restore on servers running the exact same version of LMNucleus');
...
define('_ADMIN_SYSTEMOVERVIEW_NUCLEUSSYSTEM',		'Your LMNucleus CMS System');
define('_ADMIN_SYSTEMOVERVIEW_NUCLEUSVERSION',		'LMNucleus CMS version');
define('_ADMIN_SYSTEMOVERVIEW_NUCLEUSPATCHLEVEL',	'LMNucleus CMS patch level');
...
define('_GFUNCTIONS_HEADERSALREADYSENT_TXT',		'<p>The page headers have already been sent out%s. This could cause LMNucleus not to work in the expected way.</p><p>Usually, this is caused by spaces or newlines at the end of the <code>config.php</code> file, at the end of the language file or at the end of a plugin file. Please check this and try again.</p><p>If you don\'t want to see this error message again, without solving the problem, set <code>$CONF[\'alertOnHeadersSent\']</code> in <code>globalfunctions.php</code> to <code>0</code></p>');
...
// mysql.php
define('_NO_SUITABLE_MYSQL_LIBRARY',				"<p>No suitable mySQL library was found to run LMNucleus</p>");
...
define('_ERROR_PLUGIN_LOAD',		'Plugin could not be loaded, or does not support certain features that are required for it to run on your LMNucleus installation (you might want to check the <a href="?action=actionlog">actionlog</a> for more info)');
...
define('_QMENU_INTRO_TEXT',			'<p>This is the logon screen for LMNucleus CMS, the content management system that\'s being used to maintain this website.</p><p>If you have an account, you can log on and start posting new items.</p>');
...
define('_ERROR_NUCLEUSVERSIONREQ',	'This plugin requires a newer LMNucleus version: ');
...
define('_BACKUP_INTRO',				'Click the button below to create a backup of your LMNucleus database. You\'ll be prompted to save a backup file. Store it in a safe place.');
...
define('_RESTORE_NOTE',				'<b>WARNING:</b> Restoring from a backup will <b>ERASE</b> all current LMNucleus data in the database! Only do this when you\'re really sure!	<br />	<b>Note:</b> Make sure that the version of LMNucleus in which you created the backup should be the same as the version you\'re running right now! It won\'t work otherwise');
...
define('_NOTIFY_KV_TITLE',			'LMNucleus karma:');
define('_NOTIFY_NC_MSG',			'Comment on item:');
define('_NOTIFY_NC_TITLE',			'LMNucleus comment:');
...
define('_MMAIL_FROMNUC',			'Posted from a LMNucleus weblog at');
...
define('_PLUGS_TEXT_UPDATE',		'LMNucleus keeps a cache of the event subscriptions of the plugins. When you upgrade a plugin by replacing it\'s file, you should run this update to make sure that the correct subscriptions are cached');
...
define('_WARNINGTXT_BLOGDEL',		'Warning! Deleting a blog will delete ALL items of that blog, and all comments. Please confirm to make clear that you are CERTAIN of what you\'re doing!<br />Also, don\'t interrupt LMNucleus while removing your blog.');
...
define('_ERROR_DBSELECT',			'Could not select the LMNucleus database.');
...
define('_SETTINGS_DIRS',			'LMNucleus Directories');
